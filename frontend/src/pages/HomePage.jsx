    ...
    <div className="space-y-14">
      <section className="grid items-center gap-8 lg:grid-cols-2">
        <div className="space-y-6 float-in">
          ...
          <p className="max-w-xl text-base text-emerald-50/80 md:text-lg">
          ...
          <div className="flex flex-wrap gap-3">
            <Link
              to="/upload"
              className="rounded-full bg-emerald-200 px-6 py-3 text-sm font-bold text-emerald-950 transition hover:-translate-y-0.5 hover:bg-emerald-100"
            >
              Get Started
            </Link>
            <Link
